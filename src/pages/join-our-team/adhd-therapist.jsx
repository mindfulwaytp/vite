  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      ...
      <p className="text-xl italic text-gray-700 mb-6">
        Please note: In order to complete Autism assessments, providers must be fully licensed. If you are an associate, you will be trained to conduct ADHD assessments and provide therapy, 
        and once you are fully licensed, you will be able to provide Autism assessments as well. We are open to hiring both associates and fully licensed providers for this role.
      </p>
