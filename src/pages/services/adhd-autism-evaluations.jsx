...
function ADHDAutismEvaluations() {
  return (
    <div className="bg-[#f3f6f9] text-gray-800">
      <SEO
        title="ADHD & Autism Evaluations | Mindful Way Therapy"
        description=""
      />
      ...
      <div className="mt-20 relative w-full overflow-hidden max-h-[420px]">
        <img
          src="/images/ndassessment.avif"
          alt="ADHD and Autism Evaluations"
        ...
        <div className="absolute inset-0 flex items-center justify-center px-4">
          <div className="bg-white/80 text-black px-6 py-8 rounded-xl shadow-md max-w-2xl text-center">
            <h1 className="text-3xl md:text-4xl mb-4">ADHD & Autism Evaluations</h1>
...
export default ADHDAutismEvaluations;
