...
function PolyamoryNonMonogamy() {
  return (
    <div className="bg-[#f3f6f9] text-gray-800">
      <SEO
        title="Polyamory & Non-Monogamy Support | Mindful Way Therapy"
        description=""
      />
      ...
      <div
        ...
        style={{ backgroundImage: "url('/images/polyamory.jpeg')" }}
      >
        <div className="bg-white/80 text-black px-6 py-8 rounded-xl shadow-md max-w-2xl text-center">
          <h1 className="text-3xl md:text-4xl mb-4">Polyamory & Non-Monogamy Support</h1>
