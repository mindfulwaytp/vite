...
<section className="bg-blue-50 py-8 border-b border-blue-200">
  <div className="max-w-4xl mx-auto text-center px-6">
    ...
    <p className="text-lg text-gray-800">
      ...
      Please read about our current process for completing dual assessments here: <a href="/services/autism-adhd-assessments#combined-assessment" className="text-blue-700 font-semibold underline hover:text-blue-800 transition">ADHD & Autism Evaluations</a>. We appreciate your understanding and patience.
    </p>
  </div>
</section>
