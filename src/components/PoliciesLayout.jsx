...
// Mirrors ServicesLayout: a sticky list of the sibling policies on desktop, and a
// horizontal row of chips on mobile, so each policy page links to the others.
const policyLinks = [
  { label: 'Privacy Policy', path: '/policies/privacy' },
  { label: 'Terms & Conditions', path: '/policies/terms' },
  { label: 'My Health My Data Act', path: '/policies/my-health-my-data' },
];
...
export default function PoliciesLayout({ children }) {
  ...
  return (
    <section className="bg-white pt-24 pb-16 px-4 md:px-10">
      ...
      <div className="max-w-6xl mx-auto flex gap-10 items-start">
        <aside className="hidden md:block w-60 flex-shrink-0 sticky top-28">
